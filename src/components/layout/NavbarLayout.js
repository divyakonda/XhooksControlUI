      ...
      <Box
        ...
        <DrawerHeader>
          <Grid container direction="row" justifyContent="space-between" alignItems="center">
            <Grid item>
              <Typography sx={{ ml: 1 }} fontWeight={'bold'} variant="title">
        ...
        <List sx={{ mt: 2 }}>
          ...
          <ListItemButton
            to="/new_smart_contract"
            component={Link}
            role="button"
            selected={location.pathname === '/new_smart_contract'}>
            <ListItemIcon>
              <Add />
            </ListItemIcon>
            <ListItemText primary="Create Smart Contract" />
          </ListItemButton>
        </List>
      </Box>
    </Drawer>
